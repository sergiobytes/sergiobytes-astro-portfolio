...
export const certifications: Certification[] = [
  // 2026
  // {
  //   id: "react-native-gemini",
  //   title: "Expo + Gemini: Aplicaciones con inteligencia artificial",
  //   year: 2026,
  //   inProgress: true,
  ...
  //   year: 2026,
  //   inProgress: true,
  //   icon: "https://skills.syvixor.com/api/icons?i=reactnative",
  // },
  // {
  //   id: "react-sockets-bun",
  //   title: "React + Sockets: Aplicaciones en tiempo real con Bun",
  //   year: 2026,
  //   inProgress: true,
  //   icon: "https://skills.syvixor.com/api/icons?i=websocket",
  // },
  // {
  //   id: "openai-react-nest",
  //   title: "OpenAI: Ejercicios y asistentes con React + NestJS",
  //   year: 2026,
  //   inProgress: true,
  ...
  // {
  //   id: "react-router",
  //   title: "React Router: Navegación declarativa y framework",
  //   year: 2026,
  //   inProgress: true,
  //   icon: "https://skills.syvixor.com/api/icons?i=reactrouter",
  // },
  // {
  //   id: "shadcnui",
  ...
  // {
  //   id: "zustand",
  //   title: "Zustand: Gestor de estado",
  //   year: 2026,
  //   inProgress: true,
  //   icon: "https://skills.syvixor.com/api/icons?i=zustand",
  // },
  {
    id: "react",
  ...
  },
  {
    ...
    year: 2026,
    inProgress: true,
    icon: "https://skills.syvixor.com/api/icons?i=astro",
  },
  {
  ...
  {
    id: "n8n",
    title: "n8n + MCP: Automatización y agentes de IA inteligentes",
    year: 2026,
    inProgress: true,
    icon: "https://skills.syvixor.com/api/icons?i=n8n",
  },
  {
    id: "dotnet-backend",
